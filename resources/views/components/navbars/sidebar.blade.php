<aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'pending-listings' ? ' active bg-gradient-primary' : '' }} "
                   href="{{ route('pending-listings') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">hourglass_empty</i>
                    </div>
                    <span class="nav-link-text ms-1">{{ __('listings.pending_title') }}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'users' ? ' active bg-gradient-primary' : '' }}"
                   href="{{ route('users') }}">
                    ...
                    <span class="nav-link-text ms-1">{{ __('users.title') }}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'orders.recovery' ? ' active bg-gradient-primary' : '' }}"
                   href="{{ route('orders.recovery') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">manage_search</i>
                    </div>
                    <span class="nav-link-text ms-1">{{ __('orders.recovery_title') }}</span>
                </a>
            </li>
