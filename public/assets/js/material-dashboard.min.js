...
setTimeout(function () {
    ...
    total.forEach(function (s, e) {
        ...
        var n = document.createElement("div"), a = s.querySelector(".nav-link.active").cloneNode();
...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0], s = document.querySelectorAll("div:not(.sidenav) > hr"),
        ...
        r = document.querySelectorAll("strong.text-dark"), o = document.querySelectorAll("strong.text-white"),
